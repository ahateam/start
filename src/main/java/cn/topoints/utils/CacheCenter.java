...
public class CacheCenter {
	...
	/**
	 * app 缓存</br>
	 * 为了避免反复请求app存储，增加了此缓存</br>
	 * 有效期30分钟，最大缓存对象数量100个（内存缓存1万用户，足够大了）</br>
	 * 缓存有效期1小时，OTS存储有效期2天
	 */
	public static LoadingCache<Long, App> APP_CACHE = CacheBuilder.newBuilder().expireAfterAccess(1, TimeUnit.HOURS)// 缓存对象有效时间，30分钟
			.maximumSize(10000).// 最大缓存对象数量，
